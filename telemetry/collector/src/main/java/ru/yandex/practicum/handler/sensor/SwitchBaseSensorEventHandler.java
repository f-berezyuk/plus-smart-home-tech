...
@Service
public class SwitchBaseSensorEventHandler extends BaseSensorEventHandler<SwitchSensorAvro> {

    public SwitchBaseSensorEventHandler(KafkaConfig.KafkaEventProducer producer, KafkaConfig kafkaTopics) {
